...
* El TRY–CATCH permite intentar leer desde el buffer y solo acceder a la base de datos cuando el registro no está en memoria, evitando miles de accesos innecesarios.
...
*               duration        TYPE i,
*             END OF st_connection_details.
      "Se comenta porque ya lo hereda la superclase
...
*    r_result = aggregates-sum / aggregates-count.
      ...
      "También se podría realizar de esta forma:
